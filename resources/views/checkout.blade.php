                ...
                <div class="card">
                    ...
                    <tbody>
                        <tr>
                            <td data-th="Product">
                                <div class="row">
                                    <div class="col-sm-3 hidden-xs"><img src="{{asset('/images/1.png')}}" width="100" height="100" class="img-responsive"/></div>
                                    <div class="col-sm-9">
                                        <h4 class="nomargin">Jack Daniels</h4>
                                    </div>
                                </div>
                            </td>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td colspan="5" style="text-align:right;">
                                ...
                                <input type='hidden' name="productname" value="Jack Daniels">
